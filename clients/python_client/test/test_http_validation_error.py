...
from chartgpt_client.models.http_validation_error import HTTPValidationError  # noqa: E501
...
class TestHTTPValidationError(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = chartgpt_client.models.http_validation_error.HTTPValidationError()  # noqa: E501
        if include_optional :
            return HTTPValidationError(
                detail = [
                    chartgpt_client.models.validation_error.ValidationError(
                        loc = [
                            null
                            ], 
                        msg = '', 
