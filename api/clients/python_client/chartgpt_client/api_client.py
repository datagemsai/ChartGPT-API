...
import chartgpt_client.models
from chartgpt_client import rest
from chartgpt_client.api_response import ApiResponse
from chartgpt_client.configuration import Configuration
from chartgpt_client.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(chartgpt_client.models, klass)
