...
class Response(BaseModel):
    ...
    messages: Optional[conlist(ResponseMessagesInner)] = Field(None, description="The messages of the request.")
    dataset_id: Optional[StrictStr] = Field(None, description="The dataset ID of the request.")
    ...
    __properties = ["id", "created_at", "finished_at", "status", "messages", "dataset_id", "attempts", "output_type", "outputs", "errors", "usage"]
    ...
    def from_dict(cls, obj: dict) -> Response:
        ...
        _obj = Response.parse_obj({
            ...
            "messages": [ResponseMessagesInner.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None,
