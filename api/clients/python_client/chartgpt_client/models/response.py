...
class Response(BaseModel):
    ...
    id: Optional[Any] = Field(None, description="The ID of the request.")
    ...
    __properties = ["attempts", "created_at", "data_source_url", "errors", "finished_at", "id", "messages", "output_type", "outputs", "status", "usage"]
