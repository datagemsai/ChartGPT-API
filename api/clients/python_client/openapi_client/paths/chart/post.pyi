...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["question", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["question", "type", ], str]):
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["chart"]) -> MetaOapg.properties.chart: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "code", "chart", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["chart"]) -> typing.Union[MetaOapg.properties.chart, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "code", "chart", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        chart: typing.Union[MetaOapg.properties.chart, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
ResponseHeadersFor401 = typing_extensions.TypedDict(
    ...
    {
        'WWW_Authenticate': WWWAuthenticateSchema,
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_chart_generate_chart_oapg(
        self,
...
class ApiChartGenerateChart(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_chart_generate_chart(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def api_chart_generate_chart(
        ...
        return self._api_chart_generate_chart_oapg(
            body=body,
