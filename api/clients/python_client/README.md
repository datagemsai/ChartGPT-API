...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.api_chart_generate_chart(any_type)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**api_chart_generate_chart**](docs/apis/tags/DefaultApi.md#api_chart_generate_chart) | **post** /chart | Generate a Plotly chart from a question
*DefaultApi* | [**api_sql_generate_sql**](docs/apis/tags/DefaultApi.md#api_sql_generate_sql) | **post** /sql | Generate an SQL query from a question
