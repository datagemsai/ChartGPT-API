...
If you don't know the answer respond with "Failure: I don't know the answer".
If asked to perform exploratory data analysis (EDA), please go ahead and do so without the need for further instructions.
