datasets = {
    ...
    "growjo_fatest_growing_companies": [
        ...
        "What is the average number of employees for AI companies founded between 2020 and 2022 ",
        "Plot the average revenue for CA, TX, MA, NY state companies",
    ]

}

# "Create a plot to provide an understanding of swaps across blockchains",
